...
contract SolTest is ReentrancyGuard, Ownable {
    ...
    function addWhiteList(address contractAddr) public {
        // todo: 实现设置白名单，只有owner可以操作
    }

    function removeWhiteList(address contractAddr) public {
    ...
    function swap(
        ...
        uint256 _fromTokenAmount; // 实际收到的fromToken币的数量
        uint256 _ethAmount; // 收到的eth的数量
